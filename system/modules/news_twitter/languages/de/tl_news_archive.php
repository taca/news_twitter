...
$GLOBALS['TL_LANG']['tl_news_archive']['twitter_key']		= array('Consumer key', '<a href="contao/help.php?table=tl_news_archive&field=twitter_key" onclick="Backend.openWindow(this, 600, 500); return false;">Geben Sie den "Consumer key" Ihrer Applikation ein.</a>');
$GLOBALS['TL_LANG']['tl_news_archive']['twitter_secret']	= array('Consumer secret', '<a href="contao/help.php?table=tl_news_archive&field=twitter_secret" onclick="Backend.openWindow(this, 600, 500); return false;">Geben Sie den "Consumer secret" Ihrer Applikation ein.</a>');
